...
GlitchPass.prototype = Object.assign(Object.create(Pass.prototype), {
  ...
  render: function(
    ...
    // if (this.goWild === false) {
    //   this.uniforms["byp"].value = 1;
    // } else {
    //   this.uniforms["amount"].value = Math.random() / 1000;
    //   this.uniforms["angle"].value = MathUtils.randFloat(-Math.PI, Math.PI);
    //   this.uniforms["seed_x"].value = MathUtils.randFloat(0, 1);
    //   this.uniforms["seed_y"].value = MathUtils.randFloat(0, 1);
    //   this.uniforms["distortion_x"].value = MathUtils.randFloat(-0.5, 0.5);
    //   this.uniforms["distortion_y"].value = MathUtils.randFloat(-0.5, 0.5);
    // }
    ...
    if (this.curF % this.randX === 0 || this.goWild === true) {
      ...
      this.uniforms["distortion_x"].value = MathUtils.randFloat(0, 0.5);
      this.uniforms["distortion_y"].value = MathUtils.randFloat(0, 0.5);
      this.curF = 0;
      this.generateTrigger();
  ...
  generateTrigger: function() {
    this.randX = MathUtils.randInt(400, 800);
  },
